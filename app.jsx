...
class TitleDiv extends React.Component {
  render(){
      return (
        <div>
            <HelloCSS content="比較大的字" style={ {'font-size':18} } />
            <HelloCSS content="比較小的字" style={ {'font-size':12} } />
        </div>
      )
  }
}
...
class TimerClose extends React.Component {
  ...
  render(){
      return <h1>{this.state.time}秒後將會移除</h1>
  }
}
